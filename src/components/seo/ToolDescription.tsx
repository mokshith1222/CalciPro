  ...
  return (
    <div className="mt-16 prose prose-invert max-w-none">
      <div className="bg-muted/20 border rounded-2xl p-8 mb-8">
        <h2 className="text-2xl font-black mb-4">About {shortTitle}</h2>
        ...
        <h2 className="text-xl font-bold mb-3 mt-8">How to use this tool</h2>
        ...
        <h2 className="text-xl font-bold mb-3 mt-8">Why use our {shortTitle}?</h2>
