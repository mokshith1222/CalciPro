...
export const metadata = constructMetadata({
  ...
  description: "Learn about CalcVerse, an independent calculator website built for fast, practical, privacy-conscious everyday calculations.",
});
      ...
      <div className="mt-10 space-y-8 leading-7 text-muted-foreground text-lg">
        ...
        <div className="grid md:grid-cols-2 gap-8 my-12">
          ...
          <div className="p-6 glass-card rounded-2xl border-none">
            ...
            <p className="text-sm">Your privacy matters. CalcVerse is designed to help process numbers without requiring unnecessary accounts or personal details.</p>
          </div>
        </div>

        <section className="space-y-4">
          <h2 className="text-2xl font-black text-white">Why CalcVerse Exists</h2>
          <p>
            Everyday decisions often come down to numbers: loan payments, savings goals, calorie targets, grade percentages, date differences, unit conversions, and more. CalcVerse brings those tools into one consistent experience so users can move from question to answer without switching between many unrelated sites.
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            CalcVerse is built with <span className="text-cyan-400">Next.js</span> and <span className="text-purple-400">React</span>, with attention to performance, responsive layouts, searchability, and accessible content structure. We keep calculator pages focused on the task so results are easy to scan on both desktop and mobile.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            Suggestions, corrections, and partnership questions are welcome. For more information, contact the CalcVerse team at <a className="text-cyan-400 underline-offset-4 hover:underline" href="mailto:mokshithnaik932@gmail.com">mokshithnaik932@gmail.com</a>.
          </p>
          <p>
        ...
        <section className="space-y-4 pt-8 border-t border-white/10">
          <p className="italic text-sm">
            CalcVerse is an independent project dedicated to providing free, high-quality tools and original guides for users worldwide.
          </p>
        </section>
      </div>
    </main>
